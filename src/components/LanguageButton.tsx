...
const LanguageButton = () => {
	...
	return (
		<>
			<RectButton className='language__button' onClick={onMainButtonClick} ContentComponent={getCircleSVG} />
			<ul className='language__list' data-can-show={canShowList}>
				{Object.values(Langs).map((lang) => {
					return (
						...
						>
							<button onClick={() => onLanguageSelection(lang['LANGUAGE_ABBREVIATION'])}>
								{lang['LANGUAGE']}
							</button>
						</li>
					);

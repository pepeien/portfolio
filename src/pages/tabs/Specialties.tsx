...
const SpecialtiesTab = () => {
    ...
    const [selectedSpecialty, setSelectedSpecialty] = React.useState<SpecialtyProps>(
        SpecialtiesList[0],
    );
    const [lastSelectedSpecialty, setLastSelectedSpecialty] = React.useState<SpecialtyProps>(
        SpecialtiesList[0],
    );
    ...
    return (
        <div className='specialties'>
            <div className='specialties__list'>
                <span className='specialties__sub-title'>
                    {selectedLang['SPECIALTIES_MAIN_SKILL']}
                </span>
            ...
            {selectedSpecialty && selectedSpecialty.frameworks ? (
                <div className='specialties__list'>
                    <span className='specialties__sub-title'>
                        {selectedLang['SPECIALTIES_SUB_SKILL']}
                    </span>
